...
class AzureOpenAIProvider(BaseProvider):
    ...
    def __init__(self):
        ...
        self.models = [
            {"id": "azure-gpt-4o", "name": "Azure GPT-4o", "context": 128000},
            {"id": "azure-gpt-4-turbo", "name": "Azure GPT-4 Turbo", "context": 128000},
            {"id": "gpt-4.1-nano", "name": "GPT-4.1 Nano", "context": 128000},
            {"id": "azure-gpt-4.1-nano", "name": "Azure GPT-4.1 Nano", "context": 128000},
        ]
        self.deployment_name = settings.AZURE_OPENAI_DEPLOYMENT or settings.AZURE_OPENAI_DEPLOYMENT_NAME or "gpt-4.1-nano"
    
    def _create_client(self) -> AsyncAzureOpenAI:
        """Create Azure OpenAI client"""
        # Azure endpoint should not include deployment path
    ...
    def format_messages(self, messages: List[Dict[str, Any]]) -> List[Dict[str, Any]]:
        """Format messages for Azure OpenAI API - handle tool-invocation content type"""
        formatted_messages = []
            ...
            if isinstance(content, list):
                ...
                for part in content:
                    if isinstance(part, dict):
                        ...
                        # Azure supports these types, keep them as-is
                        elif part_type in ["image_url", "input_audio", "refusal", "audio", "file"]:
                            # Keep these parts as they are supported by Azure
        ...
        **kwargs
        ...
        try:
            ...
            while current_step < max_steps:
                # Make the API call using deployment name
