...
const privacySections = [
  {
    ...
    title: "Introduction",
    icon: Shield,
    content: "Welcome to LLMHub. We are committed to protecting your privacy and ensuring the security of your personal information. This Privacy Policy explains how we collect, use, and safeguard your data when you use your AI employee that collaborates with everyone in your organization."
  },
  {
    id: "data-collection",
  ...
  },
  {
    ...
    icon: Code,
    content: "LLMHub is your AI employee that works with your entire team. While the official hosted version follows this privacy policy, we respect your data ownership. All content generated by your AI agents belongs to you, and we will never use it to train our models or share it without your explicit permission."
  },
  {
    id: "changes",
