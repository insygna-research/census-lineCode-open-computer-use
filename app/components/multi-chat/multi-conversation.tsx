      ...
      <div className="bg-background pointer-events-auto relative rounded border p-3">
        ...
        {response.message ? (
          <Message
            ...
            isChunked={(response.message as any).is_chunked}
            isCompressed={(response.message as any).is_compressed}
            truncated={(response.message as any).truncated}
            contentSize={response.message.content ? response.message.content.length : undefined}
          >
                  ...
                  <div key={groupIndex} className="mb-10 w-full space-y-3">
                    <div className="mx-auto w-full max-w-3xl">
                      <Message
                        ...
                        onReload={() => {}}
                        status="ready"
                        isChunked={(group.userMessage as any).is_chunked}
                        isCompressed={(group.userMessage as any).is_compressed}
                        truncated={(group.userMessage as any).truncated}
                        contentSize={group.userMessage.content ? group.userMessage.content.length : undefined}
                      >
