...
export function MultiChat() {
  ...
  // File upload state commented out - to be implemented in the future
  ...
  // Always use default model only
  const selectedModelIds = [MODEL_DEFAULT]
  ...
  const handleSubmit = useCallback(async () => {
    ...
    try {
        ...
        selectedChats.map(async (chat) => {
          const options = {
            body: {
              ...
              enableSearch: true, // Always enable search
              message_group_id,
            },
          }
      ...
      setPrompt("")
      // setFiles([]) // File upload commented out - to be implemented in the future
    } catch (error) {
  ...
  // File upload functions commented out - to be implemented in the future
  ...
  const inputProps = useMemo(
    () => ({
      ...
      onSend: handleSubmit,
      isSubmitting,
      // File upload props commented out - to be implemented in the future
      // files,
    ...
    [
      ...
      handleSubmit,
      isSubmitting,
      // File upload dependencies commented out
      // files,
      // handleFileUpload,
      // handleFileRemove,
      isAuthenticated,
